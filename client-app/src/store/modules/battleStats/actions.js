...
export default {
  ...
  nextBattle({ commit, dispatch }) {
    commit("monsterStats/updateMonster", null, { root: true });
    dispatch("resetStats");
  },
  ...
  doubleBattleSpeed({ commit }) {
    commit("battleMessages/doubleBattleAnimationMessageSpeed", null, {
      root: true,
    });
    commit("playerStats/doublePlayerHealthBarAnimationSpeed", null, {
      root: true,
    });
    commit("monsterStats/doubleMonsterHealthBarAnimationSpeed", null, {
      root: true,
    });
  },
  halfBattleSpeed({ commit }) {
    commit("battleMessages/halfBattleAnimationMessageSpeed", null, {
      root: true,
    });
    commit("playerStats/halfPlayerHealthBarAnimationSpeed", null, {
      root: true,
    });
    commit("monsterStats/halfMonsterHealthBarAnimationSpeed", null, {
      root: true,
    });
  },
};
