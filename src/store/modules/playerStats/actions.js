...
export default {
  attackPlayer({ commit, dispatch }) {
    ...
    dispatch('battleMessages/logBattleAction', { by: characters.MONSTER, type: monsterActions.ATTACK, value: attackValue }, { root: true });
  ...
  healPlayer({ commit, dispatch }) {
    ...
    dispatch('battleMessages/logBattleAction', { by: characters.PLAYER, type: playerActions.HEAL, value: healValue }, { root: true });
